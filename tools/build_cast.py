...
nfw = save_walk([os.path.join(SP, 'mw_%d.png' % i) for i in (1, 2, 3, 4)], 'art/char_murrinha_walk.png', STAND_MURR)
...
nvw = save_walk([os.path.join(SP, 'van_w%d.png' % i) for i in (1, 2, 3, 4)], 'art/char_vanita_walk.png', STAND_VAN)
